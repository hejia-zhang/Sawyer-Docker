...
export SAWYER_CODE_ROOT=/root/code/sawyer
echo 'export SAWYER_CODE_ROOT=/root/code/sawyer' >> "/home/$USER/.bashrc"
...
cp $SAWYER_CODE_ROOT/envs/sawyer/sawyer_learning.launch $ROS_WS/src/sawyer_simulator/sawyer_gazebo/launch
